...
#    define CATCH_INTERNAL_IGNORE_BUT_WARN(...) (void)__builtin_constant_p(__VA_ARGS__) /* NOLINT(cppcoreguidelines-pro-m_type-vararg, hicpp-vararg) */
#  endif
...
#else
    // Keep ::m_type here because we still support C++11
    template <typename Func, typename... U>
...
namespace Generators {
    ...
    // Tag m_type to signal that a generator sequence should convert arguments to a specific m_type
    template <typename T>
    struct as {};
    ...
    template<typename L>
    // Note: The m_type after -> is weird, because VS2015 cannot parse
...
namespace Catch {
    ...
    namespace {
        ...
        IStreamingReporterPtr makeReporter(std::shared_ptr<Config> const& config) {
            ...
            // when the return m_type is std::unique_ptr<IStreamingReporter>
